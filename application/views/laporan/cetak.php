            ...
            <div class="body">
				...
				<?php 
					if ($val == null ) {
						...
						?>
				<div class="head">
					<h2>laporan transaksi Bandara banwi</h2>
					<h2>jl. raya bangsri keling KM 43 Jepara</h2>
					<p style="font-weight: normal;text-transform: capitalize;">No Telepon : (025) XXX-XXX-XXX Email : <span style="text-transform: none;">bandara-kowi@gmail.com</span> no Handphone : 089-XXX-XXX-XXX</p>
